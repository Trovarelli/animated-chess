  ...
  black: {
    pawn: {
      ...
      animations: {
        ...
        death: { row: 5, frames: 4, fps: 10 },
        selected: { row: 0, frames: 6, fps: 8 }
      },
    },
    knight: {
      ...
      animations: {
        ...
        hit: { row: 4, frames: 11, fps: 12 },
        death: { row: 7, frames: 4, fps: 10 },
        selected: { row: 0, frames: 6, fps: 8 }
      },
    },
    king: {
    ...
    bishop: {
      ...
      animations: {
        idle: { row: 0, frames: 6, fps: 8 },
        walk: { row: 1, frames: 8, fps: 12 },
        attack: { row: 2, frames: 13, fps: 15 },
        hit: { row: 5, frames: 4, fps: 12 },
        death: { row: 6, frames: 4, fps: 10 },
        selected: { row: 0, frames: 6, fps: 8 }
      },
    },
    queen: {
      ...
      animations: {
        ...
        hit: { row: 4, frames: 12, fps: 15 },
        death: { row: 5, frames: 5, fps: 10 },
        selected: { row: 0, frames: 6, fps: 8 }
      },
    },
    rook: {
